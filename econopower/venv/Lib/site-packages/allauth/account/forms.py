...
# kwargs["widget"] = 
# forms.PasswordInput(attrs={"placeholder": kwargs.get("label"),
# "class": "input100",}
# )
...
class LoginForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Username or email"), "autocomplete": "email","class": "input100",}
            )
            login_field = forms.CharField(
...
class BaseSignupForm(_base_signup_form_class()):
    username = forms.CharField(
        label=_("Username"),   # Nome que aparecera acima do campo Nome de Usuario quando usar {{ form.as_p }}
        ...
        widget=forms.TextInput(
            attrs={
                ...
                "autocomplete": "username", 
                "class": "input100"
                }, # adicionar o class="" aqui
        ),
    )
    email = forms.EmailField(
        label="Email", # Nome que aparecera acima do campo Email quando usar {{ form.as_p }}
        widget=forms.TextInput(
            attrs={
                "type": "email",
                "placeholder": _("Email address"), # Placeholder de email
                "autocomplete": "email",
                "class": "input100",
                #"required": "", esse tem que ser resolvido na linha 347 á 361 se na caminho 
                # django\econopower\venv\Lib\site-packages\allauth\account\app_settings\EMAIL_REQUIRED  la na linha 102
                # pois se la estiver como True ou False vai alterar o resultado da condicional das linha 347 á 361 citadas inicialmente
    ...
    first_name = forms.CharField(
        label="Nome", # Nome que aparecera acima do campo nome quando usar {{ form.as_p }}
        min_length=app_settings.USERNAME_MIN_LENGTH,
        widget=forms.TextInput(
            attrs={
                "placeholder": "Nome",
                "class": "input100",
                "blank": False,} ## adicionar o class="" aqui
        ),
    )
    last_name = forms.CharField(
        label="Sobrenome", # Nome que aparecera acima do campo sobrenome quando usar {{ form.as_p }}
        min_length=app_settings.USERNAME_MIN_LENGTH,
        widget=forms.TextInput(
            attrs={
    ...
    def __init__(self, *args, **kwargs):
        ...
        if email_required:
            ...
            #self.fields["email"].label = gettext("Email (optional)") ## tavez alterar esse é o Nome que aparecera acima do campo Email quando usar {{ form.as_p }}
...
class SignupForm(BaseSignupForm):
    ...
    def clean(self):
        ...
        dummy_user, self.cleaned_data.get("first_name") # Nome
        dummy_user, self.cleaned_data.get("last_name") # Sobrenome
        #
